...
function App() {
  ...
  <div className="mx-auto flex max-w-screen  items-center justify-end p-6 lg:px-[100px]" aria-label="Global">
    ...
    <div className="hidden lg:flex lg:gap-x-12">
      <p className="text-green-500 font-bold">Home</p>
    <div className="relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          ...
          >
          Product
          <svg className="h-5 w-5 flex-none text-gray-400 hover:text-[#22c55e]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      ...
      <a href="#" className="text-sm font-bold leading-6 text-gray-900 hover:text-[#22c55e]">Features</a>
   
    </div>
    <div className="hidden lg:flex lg:flex-1 lg:justify-end">
      <a href="#" className="text-sm font-semibold leading-6 hover:-translate-y-1 hover: text-gray-900 bg-green-300 p-2 px-4 btn rounded-lg">Login <span aria-hidden="true">&rarr;</span></a>
    </div>
